    ...
    return Scaffold(
      body: SafeArea(
        ...
        decoration:  BoxDecoration(
          ...
          colors:  [Colors.indigo.shade800, Colors.blue],
        )),
        child: FutureBuilder(
          future: quiz,
              ...
              return SingleChildScrollView(
                child: Column(
                  children: [
                      ...
                      children: [
                        Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: Color.fromARGB(255, 225, 224, 224), width: 2),
                          ),
                          child: IconButton(
                              onPressed: () {
                        ...
                        Stack(
                          ...
                          children: [
                            normal_text(color: Colors.white, size: 24, text: "$seconds"),
                            SizedBox(
                              width: 80,
                              height: 80,
                        ...
                        Container(
                          ...
                          child: TextButton.icon(
                              ...
                              label: normal_text(color: Colors.white, size: 14, text: "Like")),
                        ),
                      ],
                    ),
                    ...
                    const SizedBox(height: 20),
                    normal_text(color: Colors.white, size: 20, text: data[currentQuestionIndex]["question"]),
                    const SizedBox(height: 20),
                    ListView.builder(
                      shrinkWrap: true,
